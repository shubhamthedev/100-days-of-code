...
- Finished the redux section today.

## R1D20

- Finished the react redux section and did 2 projects markdown previewer and quote machine generator.

![freecodecamp image r1d20](./images/r1d20.png)

## R1D21

- Beginning with the rest of the projects in this section and gonna make a good looking resume too and apply for MLH.

- I did the drum machine challenge and nothing else gotta get up to speed.

![freecodecamp image r1d21](./images/r1d21.png)

## R1D22

- Alright gonna begin with the calculator project and try finishing this section today.
- Completed the calculator project

![freecodecamp image r1d22](./images/r1d22.png)

## R1D23

- Finished the pomodoro project finally

![freecodecamp image r1d23](./images/r1d23.png)

## R1D24

- Begin by making a resume and nothing else
- Begin data visualzation over on freecodecamp
- Make a portfolio website
- At the end of the day i completed the resume and finished the data visualization section

## R1D25

- I completed the JSON API's section on freecodecamp

## R1D26

- Made a bar graph using d3

## R1D27

- Made a scatter plot using D3

## R1D28

- Made a choropleth map and a heat map

## R1D29

- Made a treemap and completed certification for data visualization

![image freecodecamp r1d29](./images/r1d29.jpeg)

## R1D31

- Started with node JS and made a simple example for beginning

![image freecodecamp r1d30](./images/r1d30.png)

## R1D31

- Gonna make portfolio's from different people using react
- Continue further with Node JS course

## R1D32

- Learned more about Node JS and how the web works

## R1D33

- Learned about Node JS back work

## R1D34

- Made my portfolio website

![image r1d34](./images/r1d34.gif)

## R1D35

- Learned about the inner workings of event loop in Node JS

## R1D36

- Try completing up until asynchronous javascript section
- Learn productivity tips and try implementing them
- Start reading books that you have on a regular basis
...
- Complete up until Handling delete requests
- Command Line Fun (OSCP)
- Practice React JS IP Address tracking project
